...
export default (getDataFn, defaultFilter, defaultSorting) => {
    return WrappedComponent => connect(mapStateToProps, mapDispatchToProps)(class WithSearch extends Component {
        constructor(props) {
            super(props);
        ...
        render() {
            ...
            return (_jsx(WrappedComponent, { filterChange: this.filterChange, reload: () => this.reload(), getQuery: this.getQuery, listProps: listProps, ...this.props }, void 0));
        }
    });
};
