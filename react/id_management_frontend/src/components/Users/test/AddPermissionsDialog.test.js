...
describe('AddPermissionsDialog component', () => {
    ...
    const width = 'md';
    const id = { id: 1138 };
    const wrapper = shallow(_jsx(AddPermissionsDialog, { error: error, handleSubmit: handleSubmit, dispatchFetchClustersForPartner: dispatchFetchClustersForPartner, onClose: onClose, onSave: onSave, open: open, reset: reset, user: user, width: width, id: id }, void 0));
    beforeEach(() => {
        jest.clearAllMocks();
    });
