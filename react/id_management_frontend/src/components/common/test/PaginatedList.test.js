...
import { styleSheet, TableRow, PaginatedList, EditButton, DeleteButton, RestoreButton, mapStateToProps, mapDispatchToProps } from '../PaginatedList';
...
describe('PaginatedList component', () => {
    ...
    const wrapper = shallow(_jsx(PaginatedList, { columns: columns, columnExtensions: columnExtensions, alternativeSorting: alternativeSorting, data: data, expandedCell: expandedCell, page: page, onPageChange: onPageChange, onDelete: onDelete, showDelete: showDelete, showRestore: showRestore, allowSorting: allowSorting, loading: loading, onEdit: onEdit, showEdit: showEdit, onExpandedRowIdsChange: onExpandedRowIdsChange, classes: classes, sorting: sorting, onSortingChange: onSortingChange, dispatchExpandedRowIds: dispatchExpandedRowIds }, void 0));
    ...
    it('runs computeInnerSorting correctly wnen alternativeSorting is falsy', () => {
        const wrapper = shallow(_jsx(PaginatedList, { columns: columns, columnExtensions: columnExtensions, data: data, expandedCell: expandedCell, page: page, onPageChange: onPageChange, onDelete: onDelete, showDelete: showDelete, showRestore: showRestore, allowSorting: allowSorting, loading: loading, onEdit: onEdit, showEdit: showEdit, onExpandedRowIdsChange: onExpandedRowIdsChange, classes: classes, sorting: sorting }, void 0));
        const instance = wrapper.instance();
        const sorted = instance.computeInnerSorting(sorting);
    ...
    it('runs sortingChange correctly when alternativeSorting is truthy', () => {
        ...
        const wrapper = shallow(_jsx(PaginatedList, { columns: columns, columnExtensions: columnExtensions, alternativeSorting: alternativeSorting, data: data, expandedCell: expandedCell, page: page, onPageChange: onPageChange, onDelete: onDelete, showDelete: showDelete, showRestore: showRestore, allowSorting: allowSorting, loading: loading, onEdit: onEdit, showEdit: showEdit, onExpandedRowIdsChange: onExpandedRowIdsChange, onSortingChange: onSortingChange, classes: classes, sorting: sorting }, void 0));
        const instance = wrapper.instance();
    ...
    it('runs sortingChange correctly when alterrnativeSorting is falsy', () => {
        const wrapper = shallow(_jsx(PaginatedList, { columns: columns, columnExtensions: columnExtensions, data: data, expandedCell: expandedCell, page: page, onPageChange: onPageChange, onDelete: onDelete, showDelete: showDelete, showRestore: showRestore, allowSorting: allowSorting, loading: loading, onEdit: onEdit, showEdit: showEdit, onExpandedRowIdsChange: onExpandedRowIdsChange, classes: classes, sorting: sorting, onSortingChange: differentSortingChange }, void 0));
        const instance = wrapper.instance();
        instance.sortingChange(sorting);
    ...
    it('runs onExpandedRowIdsChange correctly when onExpandedRowIdsChange is falsy', () => {
        const dispatchExpandedRowIds = jest.fn();
        const wrapper = shallow(_jsx(PaginatedList, { columns: columns, columnExtensions: columnExtensions, alternativeSorting: alternativeSorting, data: data, expandedCell: expandedCell, page: page, onPageChange: onPageChange, onDelete: onDelete, showDelete: showDelete, showRestore: showRestore, allowSorting: allowSorting, loading: loading, onEdit: onEdit, showEdit: showEdit, classes: classes, sorting: sorting, onSortingChange: onSortingChange, dispatchExpandedRowIds: dispatchExpandedRowIds }, void 0));
        const instance = wrapper.instance();
        const ids = 1;
        instance.onExpandedRowIdsChange(ids);
    ...
    it('runs editCell correctly when attributes are falsy', () => {
        const row = {};
        const wrapper = mount(_jsx(PaginatedList, { columns: columns, row: row, columnExtensions: columnExtensions, alternativeSorting: alternativeSorting, data: data, expandedCell: expandedCell, page: page, onPageChange: onPageChange, onDelete: onDelete, showDelete: showDelete, showRestore: showRestore, allowSorting: allowSorting, loading: loading, onEdit: onEdit, showEdit: showEdit, onExpandedRowIdsChange: onExpandedRowIdsChange, classes: classes, sorting: sorting, onSortingChange: onSortingChange, dispatchExpandedRowIds: dispatchExpandedRowIds }, void 0));
    ...
    it('runs editCell and calls clicks correctly when attributes are truthy', () => {
        ...
        const wrapper = mount(_jsx(PaginatedList, { columns: columns, row: row, columnExtensions: columnExtensions, alternativeSorting: alternativeSorting, data: data, expandedCell: expandedCell, page: page, onPageChange: onPageChange, onDelete: onDelete, showDelete: showDelete, showRestore: showRestore, allowSorting: allowSorting, loading: loading, onEdit: onEdit, showEdit: showEdit, onExpandedRowIdsChange: onExpandedRowIdsChange, classes: classes, sorting: sorting, onSortingChange: onSortingChange, dispatchExpandedRowIds: dispatchExpandedRowIds, onRestore: onRestore }, void 0));
        const tableRow = shallow(wrapper.instance().editCell(showEdit, showDelete, showRestore)(row));
    ...
    it('renders the EditButton component correctly', () => {
        ...
        const wrapper = shallow(_jsx(EditButton, { onClick: onClick }, void 0));
    ...
    it('renders the DeleteButton component correctly', () => {
        const onClick = jest.fn();
        const wrapper = shallow(_jsx(DeleteButton, { onClick: onClick }, void 0));
        wrapper.simulate('click');
        const calls = onClick.mock.calls;
        expect(calls.length).toBe(1);
    });
    it('renders the RestoreButton component correctly', () => {
        const onClick = jest.fn();
        const wrapper = shallow(_jsx(RestoreButton, { onClick: onClick }, void 0));
        wrapper.simulate('click');
        const calls = onClick.mock.calls;
        expect(calls.length).toBe(1);
    });
    ...
    it('returns the LoadingIndicator component when loading is true', () => {
        const loading = true;
        const wrapper = shallow(_jsx(PaginatedList, { columns: columns, columnExtensions: columnExtensions, data: data, expandedCell: expandedCell, page: page, onPageChange: onPageChange, onDelete: onDelete, showDelete: showDelete, showRestore: showRestore, allowSorting: allowSorting, loading: loading, onEdit: onEdit, showEdit: showEdit, classes: classes, sorting: sorting }, void 0));
