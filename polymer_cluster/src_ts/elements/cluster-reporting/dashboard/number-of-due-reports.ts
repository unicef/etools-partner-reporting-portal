...
class NumberOfDueReports extends LocalizeMixin(RoutingMixin(ReduxConnectedElement)) {
  public static get template() {
    return html`
      ...
      <iron-query-params params-string="{{resultsQuery}}" params-object="{{resultsQueryParams}}"> </iron-query-params>
  ...
  @property({
    type: Number,
    computed: 'getReduxStateValue(rootState.clusterDashboardData.data.num_of_due_overdue_indicator_reports)'
  })
