...
class PageClusterReportingSelectPlan extends RoutingMixin(ReduxConnectedElement) {
  ...
  `;
    ...
    // @ts-ignore
    _determineIfChecked(selected, id) {
        if (id === this.selected) {
            return true;
        }
        return false;
...
], PageClusterReportingSelectPlan.prototype, "query", void 0);
__decorate([
    property({ type: Object })
], PageClusterReportingSelectPlan.prototype, "queryParams", void 0);
__decorate([
    property({ type: Object })
], PageClusterReportingSelectPlan.prototype, "permissions", void 0);
__decorate([
    property({ type: Array, computed: 'getReduxStateArray(rootState.responsePlans.all)' })
], PageClusterReportingSelectPlan.prototype, "responsePlans", void 0);
__decorate([
    property({ type: Number })
], PageClusterReportingSelectPlan.prototype, "selected", void 0);
__decorate([
    property({ type: String, computed: 'getReduxStateValue(rootState.workspaces.current)' })
], PageClusterReportingSelectPlan.prototype, "workspace", void 0);
