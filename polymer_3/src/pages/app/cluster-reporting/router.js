...
class PageClusterReportingRouter extends OverlayHelperMixin(UtilsMixin(ReduxConnectedElement)) {
  ...
  `;
    ...
    _routePlanChanged(plan) {
        this.set('plan', plan);
    }
    _routeCurrentPlanChanged(id, allPlans) {
        if (!allPlans) {
            return;
        }
...
], PageClusterReportingRouter.prototype, "loading", void 0);
__decorate([
    property({ type: String })
], PageClusterReportingRouter.prototype, "plan", void 0);
__decorate([
    property({ type: String, observer: '_pageChanged' })
], PageClusterReportingRouter.prototype, "page", void 0);
__decorate([
    property({ type: Array, computed: 'getReduxStateArray(rootState.responsePlans.all)' })
], PageClusterReportingRouter.prototype, "allPlans", void 0);
__decorate([
    property({ type: Boolean, computed: '_computeViewPlannedAction(permissions)' })
], PageClusterReportingRouter.prototype, "canViewPlannedAction", void 0);
