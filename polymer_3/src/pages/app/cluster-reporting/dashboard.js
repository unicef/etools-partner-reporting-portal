...
class PageClusterReportingDashboard extends LocalizeMixin(UtilsMixin(ReduxConnectedElement)) {
  ...
  `;
    ...
    _computePageTitle(mode, localize) {
        if (!mode) {
            return undefined;
        }
        switch (mode) {
    ...
    _computeDataUrl(responsePlanId, mode) {
    ...
    _fetchData(dataUrl, queryParams) {
        ...
        this.fetchDataDebouncer = Debouncer.debounce(this.fetchDataDebouncer, timeOut.after(300), () => {
            const dataThunk = self.$.data.thunk();
            this.$.data.abort();
...
], PageClusterReportingDashboard.prototype, "queryParams", void 0);
__decorate([
    property({ type: String })
], PageClusterReportingDashboard.prototype, "route", void 0);
__decorate([
    property({ type: String })
], PageClusterReportingDashboard.prototype, "query", void 0);
__decorate([
    property({ type: String, computed: 'getReduxStateValue(rootState.responsePlans.currentID)' })
], PageClusterReportingDashboard.prototype, "responsePlanId", void 0);
__decorate([
    property({ type: String, computed: 'getReduxStateValue(rootState.auth.accountType)' })
], PageClusterReportingDashboard.prototype, "accountType", void 0);
__decorate([
    property({ type: String, computed: '_computeMode(accountType)' })
], PageClusterReportingDashboard.prototype, "mode", void 0);
__decorate([
    property({ type: String, computed: '_computePageTitle(mode, localize)' })
], PageClusterReportingDashboard.prototype, "page_title", void 0);
__decorate([
    property({ type: String, computed: '_computeDataUrl(responsePlanId, mode, queryParams)' })
], PageClusterReportingDashboard.prototype, "dataUrl", void 0);
