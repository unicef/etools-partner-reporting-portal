...
class ErrorModal extends LocalizeMixin(UtilsMixin(ReduxConnectedElement)) {
    ...
    _localizeErrors(errors, localize) {
...
__decorate([
    property({ type: Array })
], ErrorModal.prototype, "errors", void 0);
__decorate([
    property({ type: Array, computed: '_localizeErrors(errors, localize)' })
], ErrorModal.prototype, "localizedErrors", void 0);
__decorate([
    property({ type: Boolean })
], ErrorModal.prototype, "opened", void 0);
__decorate([
    property({ type: Object })
], ErrorModal.prototype, "_result", void 0);
