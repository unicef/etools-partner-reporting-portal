...
class AnalysisFilter extends UtilsMixin(ReduxConnectedElement) {
  ...
  `;
    ...
    _resetClusterObjectives() {
        this._clusterObjectivesTypeDebouncer = Debouncer.debounce(this._clusterObjectivesTypeDebouncer, timeOut.after(100), () => {
...
], AnalysisFilter.prototype, "queryParams", void 0);
__decorate([
    property({ type: Object, notify: true })
], AnalysisFilter.prototype, "filters", void 0);
