...
class PartnersPerClusterObjective extends LocalizeMixin(UtilsMixin(AnalysisChartMixin(ReduxConnectedElement))) {
    constructor() {
        super(...arguments);
        this.widgetTitle = 'Partners per Cluster Objective';
        this.cols = [
            {
...
], PartnersPerClusterObjective.prototype, "widgetTitle", void 0);
__decorate([
    property({ type: Boolean, computed: 'getReduxStateValue(rootState.analysis.operationalPresence.dataLoading)' })
], PartnersPerClusterObjective.prototype, "loading", void 0);
__decorate([
    property({ type: Object, computed: 'getReduxStateObject(rootState.analysis.operationalPresence.data.partners_per_cluster_objective)' })
], PartnersPerClusterObjective.prototype, "data", void 0);
__decorate([
    property({ type: Array })
], PartnersPerClusterObjective.prototype, "cols", void 0);
__decorate([
    property({ type: Array, computed: '_computeRows(data)' })
], PartnersPerClusterObjective.prototype, "rows", void 0);
