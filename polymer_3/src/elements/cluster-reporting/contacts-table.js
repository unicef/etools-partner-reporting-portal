...
], ContactsTable.prototype, "loading", void 0);
__decorate([
    property({ type: Array, computed: 'getReduxStateArray(rootState.contacts.all)' })
], ContactsTable.prototype, "disaggregations", void 0);
__decorate([
    property({ type: Number, computed: 'getReduxStateValue(rootState.contacts.count)' })
], ContactsTable.prototype, "totalResults", void 0);
__decorate([
    property({ type: Boolean })
], ContactsTable.prototype, "detailsOpened", void 0);
__decorate([
    property({ type: Array })
], ContactsTable.prototype, "openedDetails", void 0);
