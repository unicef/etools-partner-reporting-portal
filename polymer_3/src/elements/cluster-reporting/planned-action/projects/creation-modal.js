...
class PlannedActionProjectsModal extends LocalizeMixin(ModalMixin(RoutingMixin(UtilsMixin(ReduxConnectedElement)))) {
    ...
    _computeFromOchaDisabled(partner, selectedPartner) {
        return (!partner || !partner.ocha_external_id) &&
            (!selectedPartner || !selectedPartner.ocha_external_id);
    }
    _computeCustomDisabled(selectedPartner) {
        return !selectedPartner;
    }
    _updateMode(fromOchaDisabled, customDisabled) {
        this._setModeDebouncer = Debouncer.debounce(this._setModeDebouncer, timeOut.after(100), () => {
            if (fromOchaDisabled && !customDisabled) {
                this.set('mode', 'custom');
            }
        });
    }
    _updatePartnerForClusters(partner) {
        this.set('clusters', []);
        this.set('partnerForClusters', partner);
    }
    _computeUrl(responsePlanID, mode, edit, data) {
    ...
    _computeOchaProjectsUrl(responsePlanID) {
        if (!responsePlanID) {
            return;
        }
        return Endpoints.ochaProjectsList(responsePlanID);
    }
    _computeOchaProjectsParams(partner, selectedPartner) {
    ...
    _computeLocalizedTitle(edit, localize) {
        return edit ? localize('edit_project') : localize('add_project');
    }
    _computeAjaxMethod(edit) {
    ...
    _computeImoClusters(profile) {
        return profile.prp_roles ?
            ...
            }).map(function (item) { return item.cluster.id; }) : [];
    }
    _computeLocalizedDetailsButtonMsg(detailsOpened, localize) {
        if (detailsOpened) {
    ...
    _fetchOchaProjectsList(partner, selectedPartner) {
        this._fetchOchaProjectDebouncer = Debouncer.debounce(this._fetchOchaProjectDebouncer, timeOut.after(100), () => {
            if ((!partner || !partner.ocha_external_id) &&
                (!selectedPartner || !selectedPartner.ocha_external_id)) {
                return;
            }
            this.set('projectsLoading', true);
            const self = this;
            const projectThunk = this.$.projects;
            projectThunk.abort();
            projectThunk.thunk()()
                .then(function (res) {
                ...
                const filteredResData = res.data.filter((item) => {
    ...
    _computeOchaProjectRequestId(selectedProject) {
    ...
    _displayPartnerReadOnly(permissions, edit) {
    ...
    _save() {
        ...
        const changedLocations = rawLocations.map((location) => {
        ...
        changedLocations.forEach((location) => {
        ...
        const thunk = this.$.projectAjax.thunk();
        thunk()
            .then((res) => {
...
], PlannedActionProjectsModal.prototype, "responsePlanID", void 0);
__decorate([
    property({ type: Boolean, computed: 'getReduxStateValue(rootState.responsePlans.current.can_import_ocha_projects)' })
], PlannedActionProjectsModal.prototype, "canAddOchaProjects", void 0);
__decorate([
    property({ type: String })
], PlannedActionProjectsModal.prototype, "path", void 0);
__decorate([
    property({ type: String })
], PlannedActionProjectsModal.prototype, "reportingPeriod", void 0);
__decorate([
    property({ type: Boolean })
], PlannedActionProjectsModal.prototype, "opened", void 0);
__decorate([
    property({ type: Boolean })
], PlannedActionProjectsModal.prototype, "detailsOpened", void 0);
__decorate([
    property({ type: Boolean })
], PlannedActionProjectsModal.prototype, "updatePending", void 0);
__decorate([
    property({ type: String, observer: '_setDefaults' })
], PlannedActionProjectsModal.prototype, "mode", void 0);
__decorate([
    property({ type: Object })
], PlannedActionProjectsModal.prototype, "data", void 0);
__decorate([
    property({ type: Boolean })
], PlannedActionProjectsModal.prototype, "refresh", void 0);
__decorate([
    property({ type: String, computed: '_computeUrl(responsePlanID, mode, edit, data)' })
], PlannedActionProjectsModal.prototype, "url", void 0);
__decorate([
    property({ type: String, computed: '_computeOchaProjectsUrl(responsePlanID)' })
], PlannedActionProjectsModal.prototype, "ochaProjectsUrl", void 0);
__decorate([
    property({ type: Object, computed: '_computeOchaProjectsParams(partner, selectedPartner)' })
], PlannedActionProjectsModal.prototype, "ochaProjectsParams", void 0);
__decorate([
    property({ type: String, computed: '_computeOchaProjectDetailsUrl(selectedProject)' })
], PlannedActionProjectsModal.prototype, "ochaProjectDetailsUrl", void 0);
__decorate([
    property({ type: Object, computed: '_computeOchaProjectRequestId(selectedProject)' })
], PlannedActionProjectsModal.prototype, "ochaProjectRequestId", void 0);
__decorate([
    property({ type: Array })
], PlannedActionProjectsModal.prototype, "clusters", void 0);
__decorate([
    property({ type: String, computed: 'getReduxStateValue(rootState.partner.current)' })
], PlannedActionProjectsModal.prototype, "partner", void 0);
__decorate([
    property({ type: String, computed: 'getReduxStateValue(rootState.partner.current.id)' })
], PlannedActionProjectsModal.prototype, "partnerID", void 0);
__decorate([
    property({ type: Array, computed: 'getReduxStateArray(rootState.partnerProjects.all)' })
], PlannedActionProjectsModal.prototype, "partnerProjects", void 0);
__decorate([
    property({ type: Array, computed: '_formatForMultiselect(clusters)' })
], PlannedActionProjectsModal.prototype, "formattedClusters", void 0);
__decorate([
    property({ type: String })
], PlannedActionProjectsModal.prototype, "partnerForClusters", void 0);
__decorate([
    property({ type: Array, computed: '_computeLocalizedStatuses(resources)' })
], PlannedActionProjectsModal.prototype, "statuses", void 0);
__decorate([
    property({ type: Array })
], PlannedActionProjectsModal.prototype, "frequencies", void 0);
__decorate([
    property({ type: Array })
], PlannedActionProjectsModal.prototype, "projects", void 0);
__decorate([
    property({ type: String, computed: '_computeFormattedProjects(projects)' })
], PlannedActionProjectsModal.prototype, "formattedProjects", void 0);
__decorate([
    property({ type: String })
], PlannedActionProjectsModal.prototype, "selectedProject", void 0);
__decorate([
    property({ type: Object, computed: 'getReduxStateObject(rootState.userProfile.profile)' })
], PlannedActionProjectsModal.prototype, "profile", void 0);
__decorate([
    property({ type: Array, computed: '_computeImoClusters(profile)' })
], PlannedActionProjectsModal.prototype, "imoClusters", void 0);
__decorate([
    property({ type: Array, computed: '_computeLocalizedAgencyTypes(resources)' })
], PlannedActionProjectsModal.prototype, "agencyTypes", void 0);
__decorate([
    property({ type: Array, computed: '_computeLocalizedClassifications(resources)' })
], PlannedActionProjectsModal.prototype, "classifications", void 0);
__decorate([
    property({ type: Array })
], PlannedActionProjectsModal.prototype, "selectedClusters", void 0);
__decorate([
    property({ type: Boolean })
], PlannedActionProjectsModal.prototype, "edit", void 0);
__decorate([
    property({ type: Object })
], PlannedActionProjectsModal.prototype, "selectedPartner", void 0);
__decorate([
    property({ type: Boolean, computed: '_computeFromOchaDisabled(partner, selectedPartner)' })
], PlannedActionProjectsModal.prototype, "fromOchaDisabled", void 0);
__decorate([
    property({ type: Boolean, computed: '_computeCustomDisabled(selectedPartner)' })
], PlannedActionProjectsModal.prototype, "customDisabled", void 0);
__decorate([
    property({ type: Object })
], PlannedActionProjectsModal.prototype, "permissions", void 0);
