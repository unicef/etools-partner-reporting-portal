...
export const setPartnerActivitiesList = function (data) {
    return {
        type: Constants.SET_PARTNER_ACTIVITIES_LIST,
        data: data
    };
};
export const setPartnerActivitiesCount = function (data) {
    return {
        type: Constants.SET_PARTNER_ACTIVITIES_COUNT,
        count: data.count
    };
};
export const fetchPartnerActivitiesList = function (thunk) {
...
export const partnerActivitiesIndicatorsSetIndicators = function (partnerActivityId, data) {
    return {
...
export const partnerActivitiesIndicatorsSetCount = function (partnerActivityId, count) {
    return {
...
export const partnerActivitiesIndicatorsFetch = function (thunk, partnerActivityId) {
    return function (dispatch) {
