...
function partnerActivitiesListReducer(state = [], action) {
    switch (action.type) {
...
function partnerActivitiesCountReducer(state = 0, action) {
    switch (action.type) {
...
function loadingPartnerActivitiesReducer(state = false, action) {
    switch (action.type) {
