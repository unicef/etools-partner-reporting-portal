  ...
  public static get template() {
    ...
    return html`
      ...
      <filter-list filters="{{filters}}">
        <div class="app-grid">
          <cluster-filter class="item" value="[[_withDefault(queryParams.cluster_id, '')]]"> </cluster-filter>
          ...
          <cluster-indicator-filter class="item filter-col" value="[[_withDefault(queryParams.indicator, '')]]">
          </cluster-indicator-filter>

          <cluster-project-filter class="item filter-2-col" value="[[_withDefault(queryParams.project, '')]]">
          </cluster-project-filter>

          <indicator-location-filter class="item filter-2-col" value="[[_withDefault(queryParams.location, '')]]">
