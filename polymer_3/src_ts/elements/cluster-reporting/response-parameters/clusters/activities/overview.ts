...
class RpClustersActivityOverview extends LocalizeMixin(UtilsMixin(ReduxConnectedElement)) {
  public static get template() {
    ...
    return html`
      ...
      <page-body>
        <template is="dom-if" if="[[_canEditActivity(permissions, data.cluster)]]" restamp="true">
          <cluster-activities-editing-modal id="modal" edit-data="[[data]]"> </cluster-activities-editing-modal>
          <div id="action">
