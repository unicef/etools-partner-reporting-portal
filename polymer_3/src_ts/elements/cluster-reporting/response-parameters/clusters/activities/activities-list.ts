...
class ClustersActivityList extends LocalizeMixin(
  DataTableMixin(RoutingMixin(PaginationMixin(UtilsMixin(ReduxConnectedElement))))
) {
        ...
        <template id="list" is="dom-repeat" items="[[activities]]" as="activity" initial-count="[[pageSize]]">
          <etools-data-table-row no-collapse>
            <div slot="row-data">
              ...
              <template is="dom-if" if="[[!isMinimalList]]" restamp="true">
                <div class="table-cell table-cell--text">[[activity.cluster_title]]</div>
                <div class="table-cell table-cell--text">[[activity.cluster_objective_title]]</div>
              </template>
            </div>
