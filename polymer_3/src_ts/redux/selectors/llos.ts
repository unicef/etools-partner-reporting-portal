...
export const llosAll = createSelector(
  ...
  function (currentReport) {
    ...
    const llos = (currentReport.programme_document.cp_outputs || []).reduce(function (acc: any, curr: any) {
    ...
    return llos.map(function (llo: any) {
      ...
      change.indicator_reports = currentReport.indicator_reports.filter(function (report: any) {
