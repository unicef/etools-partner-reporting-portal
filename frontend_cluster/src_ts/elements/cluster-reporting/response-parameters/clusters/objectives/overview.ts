...
class RpClustersDetailsOverview extends LocalizeMixin(UtilsMixin(ReduxConnectedElement)) {
  public static get template() {
    ...
    return html`
      ...
      <etools-prp-ajax id="overview" url="[[overviewUrl]]"> </etools-prp-ajax>

      <page-body>
        <template is="dom-if" if="[[_canEditObjective(permissions, data.cluster)]]" restamp="true">
          <cluster-objectives-editing-modal id="modal" edit-data="[[data]]"> </cluster-objectives-editing-modal>
          <div id="action">
