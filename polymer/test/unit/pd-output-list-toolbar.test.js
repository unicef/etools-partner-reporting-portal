...
describe('PdOutputListToolbar functions', () => {
    describe('computeImportTemplateUrl function', () => {
    ...
    describe('computeImportUrl function', () => {
    ...
    describe('computePdReportUrl function', () => {
    ...
    describe('computeShowImportButton function', () => {
    ...
    describe('computeRefreshData function', () => {
        const id = 1138;
    ...
    describe('computeCanRefresh function', () => {
