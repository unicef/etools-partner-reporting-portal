...
# Will send email via our template system
...
# END COUCHBASE CONFIGURATION

INACTIVE_BUSINESS_AREAS = os.environ.get(
    'INACTIVE_BUSINESS_AREAS', '').split(',')
...
DISABLE_INVOICING = True if os.getenv('DISABLE_INVOICING', False) in \
...
SOCIALACCOUNT_ADAPTER = 'utils.mixins.CustomSocialAccountAdapter'
ACCOUNT_ADAPTER = 'utils.mixins.CustomAccountAdapter'
...
SHARED_APPS = (
    ...
    # you must list non-tenant model apps
    'users',
)
