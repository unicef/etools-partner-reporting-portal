    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gateway', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.GatewayType', verbose_name='Location Type')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('modified', model_utils.fields.AutoLastModifiedField(default=django.utils.timezone.now, editable=False, verbose_name='modified')),
                ('title', models.CharField(max_length=255)),
                ('workspace_code', models.CharField(max_length=8)),
                ...
                ('locations', models.ManyToManyField(related_name='workspaces', to='core.Location')),
            ],
            options={
                'ordering': ['title'],
            },
