...
from core.factories import ProgressReportFactory, DisaggregationFactory, DisaggregationValueFactory
from core.permissions import PartnerAuthorizedOfficerRole
from core.management.commands._generate_disaggregation_fake_data import (
  add_disaggregations_to_reportable,
  generate_0_num_disagg_data,
  generate_1_num_disagg_data,
  generate_2_num_disagg_data,
