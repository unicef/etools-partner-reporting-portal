...
urlpatterns = [
    ...
    url(r'^indicator-data-location/(?P<ir_id>\d+)/',
        IndicatorDataLocationAPIView.as_view(), name='indicator-data-location'),
    url(r'^(?P<content_object>[a-z]+)/$', IndicatorListAPIView.as_view(),
        name='indicator-list-api'),
    url(r'^(?P<pk>\d+)/$', ReportableDetailAPIView.as_view(),
        name='indicator-detail'),
    url(r'^(?P<reportable_id>\d+)/indicator-reports/$',
        IndicatorReportListAPIView.as_view(), name='indicator-report-list-api'),
    ...
    url(r'^indicator-reports/$', IndicatorReportListAPIView.as_view(),
