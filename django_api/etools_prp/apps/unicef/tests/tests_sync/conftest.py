...
def item_pd_reference():
    ...
    _workspace2 = factories.WorkspaceFactory()

    _item2 = {
        "id": 343423,
        "title": "Development of the National Social and Behavior Change (SBC) Strategy to Increase Enrollment in DepEd’s Alternative Learning System",
        "document_type": "PD",
        "business_area_code": _workspace2.business_area_code,
        "offices": [
            "Manila"
        ],
        "number": "PHI/PCA2019106/PD2022214-1",
        "status": "active",
        "workspace": _workspace2.id,
        "partner_org": {
            "short_name": "PI",
            "street_address": "",
            "last_assessment_date": "2019-07-19",
    ...
    _item2['offices'] = ", ".join(
        _item2['offices']) if _item2['offices'] else "N/A"

    return _workspace, [_item, _item2]
