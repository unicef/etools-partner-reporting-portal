...
class ProgrammeDocumentGPDProgressSerializer(serializers.ModelSerializer):
    """
    Serializer to show the progoress of a PD. This includes information
    around the CP output, LL output, and the latest gpd progress report and its
    ...
    def get_latest_accepted_pr(self, obj):
        qset = obj.gpd_progress_reports.filter(
