...
from .views import (
    ...
    ProgrammeDocumentGPDProgressAPIView,
...
urlpatterns = [
    ...
    re_path(r'^(?P<workspace_id>\d+)/programme-document/(?P<pd_id>\d+)/gpd-progress/$',
            ProgrammeDocumentGPDProgressAPIView.as_view(),
            name="programme-document-gpd-progress"),
    ...
    re_path(r'^(?P<workspace_id>\d+)/gpd-progress-reports/$',
            GPDProgressReportAPIView.as_view(),
    ...
    re_path(r'^(?P<workspace_id>\d+)/gpd-progress-reports/(?P<progress_report_id>\d+)/attachments/$',
            GPDProgressReportAttachmentListCreateAPIView.as_view(),
    ...
    re_path(r'^(?P<workspace_id>\d+)/gpd-progress-reports/(?P<progress_report_id>\d+)/attachments/(?P<pk>\d+)/$',
            GPDProgressReportAttachmentAPIView.as_view(),
