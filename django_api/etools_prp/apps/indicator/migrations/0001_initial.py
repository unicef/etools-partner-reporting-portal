    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total', models.JSONField(default={'c': 0, 'd': 1, 'v': 0})),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('external_id', models.CharField(blank=True, help_text='An ID representing this instance in an external system', max_length=32, null=True)),
                ('external_source', models.TextField(blank=True, choices=[('HPC', 'HPC'), ('OPS', 'OPS')], null=True)),
                ('target', models.JSONField(default={'d': 1, 'v': 0})),
                ('baseline', models.JSONField(default={'d': 1, 'v': 0})),
                ...
                ('location_admin_refs', django.contrib.postgres.fields.ArrayField(base_field=models.JSONField(), blank=True, default=list, null=True, size=None)),
                ('active', models.BooleanField(default=True)),
