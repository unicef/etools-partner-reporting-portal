...
# Social Auth Azure AD B2C Settings
SOCIAL_AUTH_AZUREAD_B2C_OAUTH2_TENANT_NAME = TENANT_ID  # Note: library expects TENANT_NAME, not TENANT_ID
SOCIAL_AUTH_AZUREAD_B2C_OAUTH2_AUTHORITY_HOST = TENANT_B2C_URL  # e.g., unicefpartners.b2clogin.com
SOCIAL_AUTH_AZUREAD_B2C_OAUTH2_POLICY = POLICY
SOCIAL_AUTH_AZUREAD_B2C_OAUTH2_KEY = KEY
SOCIAL_AUTH_AZUREAD_B2C_OAUTH2_SECRET = SECRET
SOCIAL_AUTH_AZUREAD_B2C_OAUTH2_SCOPE = ['openid', 'email']
SOCIAL_AUTH_AZUREAD_B2C_OAUTH2_IGNORE_DEFAULT_SCOPE = True
